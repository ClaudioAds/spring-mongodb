package com.course.springmongodb.config;

import com.course.springmongodb.domain.Post;
import com.course.springmongodb.domain.User;
import com.course.springmongodb.dto.AuthorDTO;
import com.course.springmongodb.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        CommentDTO c1 = new CommentDTO("Boa viagem mano!", sdf.parse("28/03/2018"), new AuthorDTO(alex));
